...
module.exports = {
  ...
  // This function creates a custom css file that extends main.css
  extendsMainCSS: extendsMainCSS
}
...
// This function creates a custom css file that extends main.css
function extendsMainCSS (imageNames, srcPath) {
  // console.log(imageNames)

  // Include your custom css rules here which extends/overwrites main.css and bootsrap
  let cssRules = `
.bg-article-1 {
    background: url(../images/articles/${imageNames[imageNames.length - 1]}) no-repeat center center;
...
.bg-article-2 {
    background: url(../images/articles/${imageNames[imageNames.length - 2]}) no-repeat center center;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
    background-size: cover;
...
.bg-article-3 {
    background: url(../images/articles/${imageNames[imageNames.length - 3]}) no-repeat center center;
    -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
    background-size: cover;
  ...
  // save the html file
  fse.writeFileSync(`${srcPath}/assets/stylesheet/extendsMain.css`, cssRules.toString(), 'utf8')
}
